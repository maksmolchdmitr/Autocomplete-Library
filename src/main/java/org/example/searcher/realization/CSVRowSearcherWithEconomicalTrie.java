...
import org.example.structure.mapper.realization.EconomicalTrieStringMapper;
...
public class CSVRowSearcherWithEconomicalTrie extends AbstractRowSearcher {
    private static final StringMapper<Integer> rowStartPositions = new EconomicalTrieStringMapper();

    public CSVRowSearcherWithEconomicalTrie(Filterer filterer, FileRowReader rowReader) throws IOException {
